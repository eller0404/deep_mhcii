...
df_nnalign_filename = auc_folder+nnalign_filename
df_partition_filename = partition_folder+partition_filename
df_peptides_filename = filter_folder+peptide_filename
write_random_pick_filename = auc_folder+random_pick_filename
write_mean_filename = auc_folder+mean_filename
filename_mhc_uc = auc_folder+top_mhc_uc_filename
filename_mhc_wc = auc_folder+top_mhc_wc_filename
filename_protein_uc = auc_folder+top_protein_uc_filename
filename_protein_wc = auc_folder+top_protein_wc_filename
...
df_merge = pd.concat([df_merge,df_partition[['train_EL_1', 'train_EL_2', 'train_EL_3', 'train_EL_4', 'train_EL_5', 'train_BA_1', 'train_BA_2', 'train_BA_3', 'train_BA_4', 'train_BA_5', 'train_1_9mer', 'train_2_9mer', 'train_3_9mer', 'train_4_9mer', 'train_5_9mer']]],axis=1)
...
if 'mean' in method:
    ...
    print(df_merge.columns)
    df_lig = df_merge[['acc','target','Peptide','MHC_mol','Context','Prediction_uc','Prediction_wc']]
    print('writing',write_mean_filename)
    write_df_feather(write_mean_filename,df_lig)
