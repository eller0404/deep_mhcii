...
# partition_filename = 'small_13_21_partition.ft'
# partition_9mer_filename = 'small_13_21_partition_9mer.ft'
# peptide_filename = 'small_13_21_acc.txt'
...
df_peptides = pd.read_csv(filename_peptide,sep='\t',header=None)
df_peptides.columns = ['acc','Peptide','affinity','MHC_mol','Context']

MHC = df_peptides['MHC_mol'].str.split('__')
df_peptides['MHC1'] = MHC.str[1]
df_peptides['MHC2'] = MHC.str[2]
df_peptides['MHC3'] = MHC.str[3]

df_partition = add_partition(df_peptides,filename_train)
...
df_partition = load_df_feather(filename_partition)
